...
class SkinsModal extends Component {
    static propTypes = {
    ...
    render() {
        return (
            <Dialog
                ...
                <div className="deposit__header deposit__header-pink">
                    <h3>Skins</h3>
...
export default connect(mapStateToProps, mapDispatchToProps)(SkinsModal);