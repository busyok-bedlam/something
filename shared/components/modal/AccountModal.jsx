...
import TradeURLTab from './Tabs/TradeURLTab.jsx';
import BetHistoryTab from './Tabs/BetHistoryTab.jsx';
import WithdrawalsTab from './Tabs/WithdrawalsTab.jsx';
import DepositsTab from './Tabs/DepositsTab.jsx';
...
class AccountModal extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            value: this.props.modal.tab || 'tradeURL',
            open: true,
        };
    }
